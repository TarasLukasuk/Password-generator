...
{
    internal class Password_lowercase_letters_numbers : IPassword
    {
        public Password_lowercase_letters_numbers(int Number_characters)
        {
            Number_characters_password=Number_characters;
        }

        private string Password_characters { get; set ; }= "qwertyuiopasdfghjklzxcvbnm1234567890";
