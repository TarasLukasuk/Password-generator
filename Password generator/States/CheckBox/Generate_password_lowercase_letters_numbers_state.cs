...
{
    class Generate_password_lowercase_letters_numbers_state : IState
    {
        public void Ischecked(MainWindow mainWindow)
        {
            mainWindow.Generate_password_uppercase_lowercase_letters_numbers.IsEnabled = false;
        ...
        {
            mainWindow.Generate_password_uppercase_lowercase_letters_numbers.IsEnabled = true;
